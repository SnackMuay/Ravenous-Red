...
static const struct RematchData sRematches[] = {
   { {TRAINER_YOUNGSTER_BEN, TRAINER_YOUNGSTER_BEN}, 
      MAP(MAP_ROUTE3) },
   { {TRAINER_YOUNGSTER_CALVIN, TRAINER_YOUNGSTER_CALVIN}, 
      MAP(MAP_ROUTE3) },
   { {TRAINER_BUG_CATCHER_COLTON, TRAINER_BUG_CATCHER_COLTON},
      MAP(MAP_ROUTE3) },
   { {TRAINER_CRUSH_GIRL_ISOLDE, TRAINER_CRUSH_GIRL_ISOLDE},
      MAP(MAP_ROUTE3) },
   { {TRAINER_BUG_CATCHER_JAMES, TRAINER_BUG_CATCHER_JAMES},
      MAP(MAP_ROUTE3) },
   { {TRAINER_LASS_JANICE, TRAINER_LASS_JANICE},
      MAP(MAP_ROUTE3) },
   ...
   { {TRAINER_LASS_CRISSY, TRAINER_LASS_CRISSY},
      MAP(MAP_ROUTE4) },
   { {TRAINER_PSYCHIC_LEXI, TRAINER_PSYCHIC_LEXI},
      MAP(MAP_ROUTE24) },
   { {TRAINER_PKMN_RANGER_CALE, TRAINER_PKMN_RANGER_CALE},
      MAP(MAP_ROUTE24) },
   { {TRAINER_COOLTRAINER_RELI, TRAINER_COOLTRAINER_RELI},
      MAP(MAP_ROUTE24) },
   { {TRAINER_PKMN_RANGER_ALI, TRAINER_PKMN_RANGER_ALI},
      MAP(MAP_ROUTE24) },
   { {TRAINER_PSYCHIC_SHANE, TRAINER_PSYCHIC_SHANE},
      MAP(MAP_ROUTE24) },
   { {TRAINER_COOLTRAINER_ETHAN, TRAINER_COOLTRAINER_ETHAN},
      MAP(MAP_ROUTE24) },
   { {TRAINER_YOUNGSTER_JOEY, TRAINER_YOUNGSTER_JOEY},
      MAP(MAP_ROUTE25) },
   { {TRAINER_YOUNGSTER_DAN, TRAINER_YOUNGSTER_DAN},
      MAP(MAP_ROUTE25) },
   { {TRAINER_YOUNGSTER_CHAD, TRAINER_YOUNGSTER_CHAD},
      MAP(MAP_ROUTE25) },
   { {TRAINER_PICNICKER_KELSEY, TRAINER_PICNICKER_KELSEY},
      MAP(MAP_ROUTE25) },
   { {TRAINER_LASS_HALEY, TRAINER_LASS_HALEY},
      MAP(MAP_ROUTE25) },
   { {TRAINER_HIKER_FRANKLIN, TRAINER_HIKER_FRANKLIN},
      MAP(MAP_ROUTE25) },
   ...
   { {TRAINER_YOUNGSTER_DILLON, TRAINER_YOUNGSTER_DILLON},
      MAP(MAP_ROUTE11) },
   { {TRAINER_COOLTRAINER_HOLLY, TRAINER_COOLTRAINER_HOLLY},
      MAP(MAP_ROUTE11) },
   { {TRAINER_COOLTRAINER_DAVE, TRAINER_COOLTRAINER_DAVE},
      MAP(MAP_ROUTE11) },
   { {TRAINER_BIRD_KEEPER_BRAXTON, TRAINER_BIRD_KEEPER_BRAXTON},
      MAP(MAP_ROUTE11) },
   { {TRAINER_HIKER_BERNIE, TRAINER_HIKER_BERNIE},
      MAP(MAP_ROUTE11) },
   ...
   { {TRAINER_SWIMMER_FEMALE_NORA, TRAINER_SWIMMER_FEMALE_NORA},
      MAP(MAP_ROUTE20) },
   { {TRAINER_SWIMMER_FEMALE_MELISSA, TRAINER_SWIMMER_FEMALE_MELISSA},
      MAP(MAP_ROUTE20) },
