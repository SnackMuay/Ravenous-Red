...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_PIN_MISSILE] =
    {
        ...
        .type = TYPE_BUG,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_6 ? 95 : 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_MINIMIZE] =
    {
        ...
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = B_UPDATED_MOVE_DATA >= GEN_6 ? 10 : 2,
        .target = MOVE_TARGET_USER,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_RESET_STATS },
    ...
    [MOVE_SMOG] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "that may\nalso poison."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 30 : 30,
        .type = TYPE_POISON,
        .accuracy = 80,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_RAPID_SPIN] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_8 ? 50 : 50,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_POISON_FANG] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            ...
            .chance = B_UPDATED_MOVE_DATA >= GEN_6 ? 50 : 50,
        }),
    ...
    [MOVE_ROCK_TOMB] =
    {
        ...
        .type = TYPE_ROCK,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_6 ? 95 : 90,
    ...
    [MOVE_HOWL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "and boosts\nAttack."),
        .power = 0,
        .effect = B_UPDATED_MOVE_DATA >= GEN_5 ? EFFECT_ATTACK_UP_USER_ALLY : EFFECT_ATTACK_UP,
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = 40,
    ...
    [MOVE_COVET] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "item\nheld by the foe."),
        .effect = EFFECT_STEAL_ITEM,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 50 : 40,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_6 ? 25 : 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = B_UPDATED_MOVE_DATA >= GEN_4,
    ...
    [MOVE_INCINERATE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "\npreventing their\nuse."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 60 : 30,
        .type = TYPE_FIRE,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_BOTH,
    ...
    {
        .name = COMPOUND_STRING("Stompin Tantrum"),
        .description = COMPOUND_STRING(
            "Stomps around\nangrily. "
            "Stronger\nafter a failure."),
