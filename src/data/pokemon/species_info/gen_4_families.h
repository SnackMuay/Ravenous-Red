...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    #else
        .abilities = { ABILITY_TORRENT, ABILITY_NONE, ABILITY_BIG_PECKS },
    #endif
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_LOPUNNY, CONDITIONS({IF_KNOWS_MOVE, MOVE_JUMP_KICK})}),
    },
    ...
    [SPECIES_RIOLU] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_LUCARIO, CONDITIONS({IF_KNOWS_MOVE, MOVE_METAL_SOUND})}),
    },
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .abilities = { ABILITY_RATTLED, ABILITY_POISON_TOUCH, ABILITY_DRY_SKIN },
        .bodyColor = BODY_COLOR_BLUE,
