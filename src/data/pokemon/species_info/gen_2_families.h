...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_QUICK_FEET, ABILITY_NONE, ABILITY_INFILTRATOR },
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .abilities = { ABILITY_ILLUMINATE, ABILITY_NONE, ABILITY_VOLT_ABSORB },
        .bodyColor = BODY_COLOR_BLUE,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_TOGETIC, CONDITIONS({IF_KNOWS_MOVE, MOVE_WISH})}),
    },
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_NONE, ABILITY_SIMPLE },
        .bodyColor = BODY_COLOR_WHITE,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_AZURILL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_MARILL, CONDITIONS({IF_KNOWS_MOVE, MOVE_WATER_GUN})}),
    },
    ...
    [SPECIES_AIPOM] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FRISK, ABILITY_NONE, ABILITY_SKILL_LINK },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_TEDDIURSA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_RUN_AWAY, ABILITY_QUICK_FEET, ABILITY_HONEY_GATHER },
    #else
        .abilities = { ABILITY_RUN_AWAY, ABILITY_NONE, ABILITY_HONEY_GATHER },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_MAGCARGO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_SOLID_ROCK, ABILITY_MAGMA_ARMOR },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_VITAL_SPIRIT, ABILITY_HUSTLE, ABILITY_HOSPITALITY },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_EARLY_BIRD, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    #else
        .abilities = { ABILITY_THICK_FAT, ABILITY_NONE, ABILITY_CUD_CHEW },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_TYRANITAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_NONE, ABILITY_SAND_STREAM },
        .bodyColor = BODY_COLOR_GREEN,
