...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_LINOONE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_LIMBER, ABILITY_GLUTTONY, ABILITY_QUICK_FEET },
    #else
    ...
    #else
        .abilities = { ABILITY_HYDRATION, ABILITY_NONE, ABILITY_GLUTTONY },
    #endif
        .bodyColor = BODY_COLOR_WHITE,
    ...
    #else
        .abilities = { ABILITY_RAIN_DISH, ABILITY_NONE, ABILITY_UNBURDEN },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_MAKUHITA] =
    {
        ...
        .abilities = { ABILITY_THICK_FAT, ABILITY_NONE, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_BUDEW] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_ROSELIA, CONDITIONS({IF_KNOWS_MOVE, MOVE_GROWTH})}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_SWABLU] =
    {
        ...
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_CLOUD_NINE, ABILITY_EARLY_BIRD },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_BARBOACH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_WATER_VEIL, ABILITY_HYDRATION },
    #else
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_CHIMECHO, CONDITIONS({IF_KNOWS_MOVE, MOVE_UPROAR})}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_CLAMPERL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_HUNTAIL, CONDITIONS({IF_HOLD_ITEM, ITEM_DEEP_SEA_TOOTH})},
