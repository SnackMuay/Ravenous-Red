...
// Medicine
    ...
    [ITEM_HYPER_POTION] =
    {
        ...
        .price = (I_PRICE >= GEN_2 && I_PRICE <= GEN_6) ? 1200 : 400,
        .holdEffectParam = 120,
        .description = COMPOUND_STRING(
            "Restores the HP of "
            "a Pokémon by "
    ...
    [ITEM_BURN_HEAL] =
    {
        ...
        .price = (I_PRICE == GEN_7) ? 10 : ((I_PRICE <= GEN_7) ? 10 : 10),
        .description = COMPOUND_STRING(
            "Heals Pokémon "
            "of a burn."),
        .pocket = POCKET_ITEMS,
    ...
    [ITEM_ICE_HEAL] =
    {
        ...
        .price = (I_PRICE == GEN_7) ? 100 : ((I_PRICE <= GEN_7) ? 250 : 10),
        .description = COMPOUND_STRING(
            "Defrosts a frozen "
            "Pokémon."),
        .pocket = POCKET_ITEMS,
    ...
    [ITEM_AWAKENING] =
    {
        ...
        .price = (I_PRICE >= GEN_2 && I_PRICE <= GEN_6) ? 10 : ((I_PRICE == GEN_7) ? 100 : 10),
        .description = COMPOUND_STRING(
            "Awakens a sleeping "
            "Pokémon."),
        .pocket = POCKET_ITEMS,
...
// Berries
    ...
    [ITEM_CHERI_BERRY] =
    {
        ...
        .price = (I_BERRY_PRICE >= GEN_8) ? 80 : 10,
...
// Misc. Key Items
    ...
    [ITEM_CANDY_BAR] =
    {
        ...
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CandyBar,
        .effect = gItemEffect_RareCandy,
        .iconPic = gItemIcon_RareCandy,
        .iconPalette = gItemIconPalette_RareCandy,
    },
