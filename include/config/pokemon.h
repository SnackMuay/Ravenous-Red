...
#define P_EVOLUTION_LEVEL_1_LEARN   GEN_8       // In Gen 8+, Pokémon evolving while at level 1 do not get the chance to learn their level 1 moves, while before they did.

// Evolution settings
#define P_FRIENDSHIP_EVO_THRESHOLD   GEN_8      // Since Gen 8, Pokémon that evolve by friendship evolve at or above 160 friendship instead of 220.
...
#define P_EGG_CYCLE_LENGTH               GEN_8       // Since Gen 8, egg cycles take half as many steps as before. Previous Gens have some varied step counts around 255.
